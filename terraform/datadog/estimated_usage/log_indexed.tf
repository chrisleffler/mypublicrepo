...
resource "datadog_monitor" "log_indexed" {
  ...
  type               = "metric alert"
  message            = "Your Datadog Log Event Indexing is {{value}} which is within 20% of your commitment. Recommend [Plan & Usage evaluation](https://app.${var._site}/billing/usage) or contact your Datadog Account Team."
